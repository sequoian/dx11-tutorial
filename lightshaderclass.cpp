...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"VertexLight.hlsl", L"PixelLight.hlsl");
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, LPCWCHAR vsFilename, LPCWCHAR psFilename)
{
	HRESULT result;
